                ...
                >
                    ...
                    <div className="mt-6">
                        ...
                        <div className="mt-4 grid grid-cols-2 gap-3">
                            <button className="flex items-center justify-center gap-2 bg-slate-700/50 hover:bg-slate-700 text-white py-2 px-4 rounded-lg transition-all border border-slate-600">
                            ...
                            <button className="flex items-center justify-center gap-2 bg-slate-700/50 hover:bg-slate-700 text-white py-2 px-4 rounded-lg transition-all border border-slate-600">
                                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M11.4 24H0V8h11.4v16zM24 8v16h-11.4V8H24M11.4 0v7H0V0h11.4m12.6 0v7H12.6V0H24" />
                                </svg>
                                Microsoft
                            </button>
                        </div>
